...
using Aster.Framework.Common.Data.Predicates;

namespace Aster.Framework.Common.Data.Implementor
{
    public partial class DapperImplementor : IDapperImplementor
    {
        ...
        public IEnumerable<T> GetListPaged<T>(IDbConnection connection, object predicate, IList<ISort> sort, IDbTransaction transaction, int? commandTimeout, bool buffered, int offset, int limit, bool nolock) where T : class
        {
            IClassMapper classMap = SqlGenerator.Configuration.GetMap<T>();
            IPredicate wherePredicate = GetPredicate(classMap, predicate);
            return GetListPaged<T>(connection, classMap, wherePredicate, sort, transaction, commandTimeout, buffered, offset, limit, nolock);
        }
        ...
        private IEnumerable<T> GetListPaged<T>(IDbConnection connection, IClassMapper classMap, IPredicate predicate, IList<ISort> sort, IDbTransaction transaction, int? commandTimeout, bool buffered, int offset, int limit, bool nolock) where T : class
        {
            Dictionary<string, object> parameters = new Dictionary<string, object>();
